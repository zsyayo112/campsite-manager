      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-20">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-gray-900">为什么选择我们？</h3>
            <p className="mt-4 text-lg text-gray-600">专为营地行业定制的管理解决方案</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibold text-gray-900 mb-3">快速部署</h4>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibold text-gray-900 mb-3">安全可靠</h4>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibold text-gray-900 mb-3">智能分析</h4>
              <p className="text-gray-600">
