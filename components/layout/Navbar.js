        ...
        <div className="flex justify-between items-center h-16">
            ...
            <Link href="/" className="flex items-center ml-4">
              <div className="flex items-center">
                ...
                <div className="ml-3 hidden sm:block">
                  ...
                  <p className="text-xs text-gray-500 -mt-1">Campsite Manager</p>
                </div>
              </div>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors duration-200 relative">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5-5 5-5M4 9l5-5v3h6v4H9v3z" />
              </svg>
              {/* 通知小红点 */}
              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="hidden md:block text-left">
                    ...
                    <p className="text-xs text-gray-500">{user.role || '管理员'}</p>
                  </div>
                  {/* 下拉箭头 */}
